package com.amsterly.lovecoder.lovecoder.ui.widget;
...
public class AqiView extends View {
    ...
    private float QualityNum=1;
    //	public String CityName;
    private String QualityResult="";

    public void setQuality(float qualityNum, String qualityResult) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            currAqiPercent = Float.valueOf(QualityNum) / 500f;// 污染%
        ...
        if (currAqiPercent >= 0f) {
            ...
            textPaint.setColor(0xffffffff);
            try {
                canvas.drawText(QualityNum + "", 0, lineSize * 3, textPaint);
            } catch (Exception e) {
            }
            textPaint.setTextSize(lineSize * 1f);
            textPaint.setColor(0x88ffffff);
            try {
                canvas.drawText(QualityResult + "", 0, lineSize * 4.25f, textPaint);
            } catch (Exception e) {
            }
