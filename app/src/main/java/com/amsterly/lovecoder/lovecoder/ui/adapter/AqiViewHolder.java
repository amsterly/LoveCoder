...
import com.amsterly.lovecoder.lovecoder.ui.widget.customview.LevelView;
import com.amsterly.lovecoder.lovecoder.utils.Check;
import com.amsterly.lovecoder.lovecoder.utils.UIUtil;
...
public class AqiViewHolder extends BaseViewHolder<AqiData> {
    ...
    @Bind(R.id.pm2_5_view)
    LevelView pm2_5View;
    @Bind(R.id.pm2_5_value)
    TextView pm2_5Value;
    @Bind(R.id.pm10_view)
    LevelView pm10View;
    @Bind(R.id.pm10_value)
    TextView pm10Value;
    @Bind(R.id.aqi_advice)
    TextView aqiAdvice;
