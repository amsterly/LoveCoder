...
//    private static final int[] NOTIFICATION_THEMES_NAMES = {R.string.follow_system, R.string.pure_white};
    ...
    private static final int[] ICONS_ID = {R.drawable.weather_clouds, R.drawable.weather_sunny, R.drawable.weather_few_clouds, R.drawable.weather_big_rain, R.drawable.weather_rain, R.drawable.weather_snow, R.drawable.weather_wind, R.drawable.weather_haze, R.drawable.weather_rain_snow};
